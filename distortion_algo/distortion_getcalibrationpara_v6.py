...
# - written in function
# ##v5
# - modify the function to avoid unnecessary error messages
# =============================================================================
...
def get_camera_parameters(number_rows, number_cols, input_folder, print_params=False):
    ...
    #find_flags = cv.CALIB_CB_ADAPTIVE_THRESH
    ...
    # read images
    images = glob.glob(os.path.join(input_folder, '*gray_r.JPG')) 
    fail_all = True
    ...
    for fname in images:
        ...
        # gray = cv.cvtColor(image_inverted, cv.COLOR_BGR2GRAY)  
        ...
        if ret == True:
            ...
            cv.imwrite('test_IR'+ img_name[-1], img)
...
if __name__ == '__main__':
    get_camera_parameters(7, 4, r'C:/Users/cryst/Work/Facade_inspection/thermal/Tomita/Thermal/distortion_algo/02_outdoor_ground_results_v3/', True)
