...
if __name__ == '__main__':
    get_camera_parameters(7, 4, '/home/paul/Workspaces/python/Drone_io_pipeline-main/Thermal/RGB_IR_overlay/thermal_analysis/calibration_ir_raw/', True)
