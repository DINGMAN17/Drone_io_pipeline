...
#name,inspection_no,facade_no, 
	...
	def __init__(self,name,inspection_no,buildingID,frequency=[3],
		...
		'''	
		self.root = r'/home/paul/Workspaces/python/Drone_io_pipeline-main/real_dataset/test_thermal_preprocess'
		self.name = name
...
if __name__ == '__main__':
	...
	buildingID = '5'
	name = 'bishan'
	preprocess = Preprocess(name, inspection_no, buildingID, [2], handheld=handheld, thermal=thermal)
